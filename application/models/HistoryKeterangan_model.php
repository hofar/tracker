...
class HistoryKeterangan_model extends CI_Model
{
    ...
    public function __construct()
    {
        ...
        $this->column_order = array(null, null, $this->table_proker . '.name', $this->table . '.status', $this->table . '.keterangan', $this->table . '.created_at', null); //set column field database for datatable orderable
        $this->column_search = array($this->table_proker . '.name', $this->table . '.status', $this->table . '.keterangan', $this->table . '.created_at');  //set column field database for datatable searchable just firstname , lastname , address are searchable
